        ...
        <main className="m-10">
            <div className="m-5">
                ...
                <form action={updateNote} className="space-y-5">
                    <input type="text" name='note' id='note' placeholder="Add Notes" defaultValue={result.note} className="shadow-lg rounded-md text-black shadow-black h-10 p-3 w-[100%]"/>
                    <input type="date" name='date' id='date' placeholder="Add Date" defaultValue={result.date} className="shadow-lg rounded-md text-black shadow-black h-10 p-3 w-[100%]"/>
